...
def _solve_iri_challenge_and_fetch(url: str, session: curl_requests.Session) -> str:
    url = url.replace("https://indiarailinfo.com", "https://d.indiarailinfo.com").replace("https://m.indiarailinfo.com", "https://d.indiarailinfo.com")
    headers = {
        "User-Agent": "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36",
        "Referer": "https://d.indiarailinfo.com/"
    }
...
def _resolve_iri_slug(train_no: str, session: curl_requests.Session) -> str:
    ...
    # Strategy 4: d.indiarailinfo.com Search with JS Verification Solver
    try:
        search_url = f"https://d.indiarailinfo.com/trains?q={train_no}"
...
def fetch_train_indiarailinfo(train_no: str) -> Optional[dict]:
    ...
    iri_url = f"https://d.indiarailinfo.com/train/{train_id}"
